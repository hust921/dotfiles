...
vim.opt.autochdir = true                        -- automatically change cwd when changing buffer
...
vim.cmd('autocmd BufEnter *.html,*.hbs,*.tsx setlocal shiftwidth=2 tabstop=2 softtabstop=2 expandtab')
